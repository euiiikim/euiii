...
class ZORO:
    ...
    def __init__(self):
        ...
        self.jump_state = "up"
        self.hp = 1000
        self.attack_sound = load_music('zoro_attack.mp3')
        self.attack_sound.set_volume(30)
        self.crush_sound = load_music('zoro_crush.mp3')
        self.crush_sound.set_volume(30)
        self.jump_sound = load_music('zoro_jump.mp3')
        ...
        if self.image_init == None:
            ...
            self.slide = load_image('zoro_slide.png')
