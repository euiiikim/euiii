...
crr_data_file = open('data/crrdata', 'r')
crr_data = json.load(crr_data_file)
crr_data_file.close()
crr2_data_file = open('data/crrdata2', 'r')
...
class Crr:
    ...
    def __init__(self):
        self.speed = 10
        self.distance = 0
        self.crr_sound = load_music('music/jelly.mp3')
        self.crr_sound.set_volume(30)
        if Crr.image == None:
            self.crr = load_image('image/crr.png')
...
class Crr2:
    ...
    def __init__(self):
        ...
        self.crr_sound.set_volume(30)
        if Crr2.image == None:
            self.crr2 = load_image('image/crr.png')
