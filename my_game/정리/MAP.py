...
class MAP:
    ...
    def __init__(self):
        ...
        self.distance = 0
        self.count = 0
        self.bgm = load_music('music/stage1_music.mp3')
        self.bgm.set_volume(40)
        self.bgm.repeat_play()

        if self.image_init == None:
            self.map1 = load_image('image/navymap1.png')
            self.map2 = load_image('image/navymap2.png')
            self.map3 = load_image('image/navymap3.png')
...
class MAP2:
    ...
    def __init__(self):
        ...
        self.distance = 0
        self.count = 0
        self.bgm = load_music('music/stage2_music.mp3')
        self.bgm.set_volume(40)
        self.bgm.repeat_play()

        if self.image_init == None:
            self.map1 = load_image('image/aronmap1.png')
            self.map2 = load_image('image/aronmap2.png')
            self.map3 = load_image('image/aronmap1.png')
