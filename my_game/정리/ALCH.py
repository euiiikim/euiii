...
alch_data_file = open('data/alchdata', 'r')
alch_data = json.load(alch_data_file)
alch_data_file.close()
alch2_data_file = open('data/alchdata2', 'r')
...
class Alch:
    ...
    def __init__(self):
        self.speed = 10
        self.distance = 0
        self.alch_sound = load_music('music/jelly.mp3')
        self.alch_sound.set_volume(30)
        if Alch.image == None:
            self.alch = load_image('image/alch.png')
...
class Alch2:
    ...
    def __init__(self):
        ...
        self.alch_sound.set_volume(30)
        if Alch2.image == None:
            self.alch2 = load_image('image/alch.png')
