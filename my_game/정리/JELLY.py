...
jelly_data_file = open('data/jellydata', 'r')
jelly_data = json.load(jelly_data_file)
jelly_data_file.close()

jelly2_data_file = open('data/jellydata2', 'r')
...
class Jelly:
    ...
    def __init__(self):
        self.speed = 10
        self.distance = 0
        self.jelly_sound = load_music('music/jelly.mp3')
        self.jelly_sound.set_volume(30)

        if Jelly.image == None:
            self.jelly = load_image('image/jelly1.png')
...
class Jelly2:
    ...
    def __init__(self):
        ...
        if Jelly2.image == None:
            self.jelly2 = load_image('image/jelly1.png')
